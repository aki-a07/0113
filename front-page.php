<?php get_header(); ?>
    ...
    <?php if(have_posts()): while(have_posts()): the_post(); ?>
        ...
        <section class="content-b">
            <div class="box-gird">
            <div class="box">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/240x240.png" alt="説明文">
                <p>テキストテキスト</p>
            </div>
            <div class="box">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/240x240 (1).png" alt="説明文">
                <p>テキストテキスト</p>
            </div>
            <div class="box">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/240x240 (2).png" alt="説明文">
                <p>テキストテキスト</p>
            </div>
            </div>
            <div class="more">
            <a href="/menu/index.html">more...</a>
        </div>
        </section>
